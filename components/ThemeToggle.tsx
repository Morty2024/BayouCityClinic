...
const ThemeToggle: React.FC = () => {
  ...
  if (!mounted) {
    // Render a placeholder or null during server-side rendering or initial mount
    // to avoid hydration mismatch.
    return (
      <div className="w-5 h-5 p-2 rounded-full bg-gray-200 dark:bg-gray-700 animate-pulse"></div>
    );
  }
